...
def RewriteQuery():
	...
	if "sum" in select_strings[0]:
		...
		rewrite_query = rewrite_query + select_strings[0][4 : -1] + ", "
...
def main(argv):
	...
	try:
		...
		print("ExtractInfoFull.py -D <database name> -Q <query file path> -P <private relation name> -K <primary key of private relation> -O <output file>")
		sys.exit(2)
	for opt, arg in opts:
		if opt == '-h':
			print("ExtractInfoFull.py -D <database name> -Q <query file path> -P <private relation name> -K <primary key of private relation> -O <output file>")
